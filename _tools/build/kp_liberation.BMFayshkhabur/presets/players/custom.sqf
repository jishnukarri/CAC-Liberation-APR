...
KPLIB_b_objectsDeco = [
    ...
    ["Land_obstacle_prone", 0, 0, 0],
    ["Land_IronPipes_F", 0, 0, 0],
    ["Misc_cargo_cont_net2", 0, 0, 0],
    ["Land_Misc_IronPipes_EP1", 0, 0, 0],
    ...
    ["Land_GarbagePallet_F", 0, 0, 0],
    ["FenceWoodPalet", 0, 0, 0],
    ["CUP_A2_ohrada_popelnice_roh", 0, 0, 0],
    ["Land_CncBarrier_F", 0, 0, 0],
    ["Land_CncBarrier_stripes_F", 0, 0, 0],
    ["Land_CncBlock_D", 0, 0, 0],
    ["Land_CncBlock_Stripes", 0, 0, 0],
    ["Land_Pneu", 0, 0, 0],
    ["CUP_A2_ohrada_popelnice", 0, 0, 0],
    ["Land_GarbageBags_F", 0, 0, 0],
    ["Land_GarbageWashingMachine_F", 0, 0, 0],
    ["CUP_A2_windbreak", 0, 0, 0],
    ["Hedgehog", 0, 0, 0],
    ...
    ["Land_BarrelWater_grey_F", 0, 0, 0],
    ["Land_BarrelTrash_grey_F", 0, 0, 0],
    ["Land_CratesShabby_F", 0, 0, 0],
    ["Land_CratesWooden_F", 0, 0, 0],
    ["Misc_concrete_High", 0, 0, 0],
    ["Land_Pallets_stack_F", 0, 0, 0],
    ["Barrel4", 0, 0, 0],
    ["Fort_Crate_wood", 0, 0, 0],
    ["Land_Sack_F", 0, 0, 0],
    ["Land_Sacks_heap_F", 0, 0, 0],
    ["Land_PaperBox_open_full_F", 0, 0, 0],
    ["Oil_Spill_F", 0, 0, 0],
    ["Land_Sack_EP1", 0, 0, 0],
    ...
    ["Land_WaterBarrel_F", 0, 0, 0],
    ["Land_PaperBox_closed_F", 0, 0, 0],
    ["Land_BarrelSand_grey_F", 0, 0, 0],
    ["Land_WoodenBox_F", 0, 0, 0],
    ["Barrel5", 0, 0, 0],
    ["PowerGenerator", 0, 0, 0],
    ["Land_WheelCart_F", 0, 0, 0],
    ["Misc_cargo_cont_tiny", 0, 0, 0],
    ["Misc_Backpackheap", 0, 0, 0],
    ["Land_BagSmall_F", 0, 0, 0],
    ["CUP_A2_fuelstation", 0, 0, 0],
    ["Land_Barracks_EP1", 0, 0, 0],
    ["Land_Misc_Cratewood_EP1", 0, 0, 0],
    ["Land_Barracks_Police_EP1", 0, 0, 0],
    ["Land_Fortification_EP1", 0, 0, 0],
    ["Land_Tent1_EP1", 0, 0, 0],
    ["Land_Tent2_EP1", 0, 0, 0],
    ["Land_Tent3_EP1", 0, 0, 0],
    ["Land_CamoNetB_F", 0, 0, 0],
    ["Land_CamoNetF_F", 0, 0, 0],
    ["Land_CamoNet_NATO_EP1", 0, 0, 0],
    ["Land_Shelter_1x1_EP1", 0, 0, 0],
    ["Land_Shelter_2x1_EP1", 0, 0, 0],
    ["Land_Shelter_1x2_EP1", 0, 0, 0],
    ["Land_Ind_FuelTank_EP1", 0, 0, 0]
];
